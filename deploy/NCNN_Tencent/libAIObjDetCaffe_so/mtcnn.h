...
public:
    ...
    MTCNN(const unsigned char* param_mem, const unsigned char* bin_mem);
	...
	void SSDDetect(ncnn::Mat& img_, std::vector<float>& objInfo_, int*);
